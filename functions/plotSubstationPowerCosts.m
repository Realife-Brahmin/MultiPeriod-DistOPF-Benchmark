function plotSubstationPowerCosts(results)
    ...
    PSubsCost_1toT = results.PSubsCost_1toT;
    data0 = PSubsCost_1toT(1:T);
    ...
    titlePre = "$P_{SubsCost}$";
    yLabelString = "$P_{SubsCost} \, [\$]$";
    filenamePre = "SubstationRealPowerCosts";
