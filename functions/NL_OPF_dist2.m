function [x, B0Vals_pu_Area, ...
 ...
 % Default values for optional arguments
    ...
    options = optimoptions('fmincon', 'Display', 'iter-detailed', 'MaxIterations', 30, 'MaxFunctionEvaluations', 100000000, 'Algorithm', 'sqp', 'PlotFcn', @optimplotfval);
    ...
    [x, fval] = fmincon( @(x)objfun(x, areaInfo, T, 'objective', {"func_PLoss", "func_SCD", "func_netChangeInSOC"}), ...
                              x0, [], [], Aeq, beq, lb, ub, ...
