function [x, sysInfo, simInfo, ...
 ...
 % Default values for optional arguments
    ...
    [busDataTable_Area, branchDataTable_Area, edgeMatrix_Area, R_Area, X_Area] ...
        = extractAreaElectricalParameters(Area, macroItr, isRoot_Area, systemName, numAreas, ...
    ...
    prefixName = strcat(folderName, filesep, "Horizon_", num2str(T), "_macroItr_", num2str(macroItr));
