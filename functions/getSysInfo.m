function sysInfo = getSysInfo(sysInfo, simInfo, systemName, varargin)
 ...
 % Default values for optional arguments
    ...
    % disp(length(fieldnames(areaInfo)));
    sysInfo = getSysParameters(sysInfo, simInfo, busDataTable_pu_Area, branchDataTable_Area, R_Area, X_Area);
