function plot_simulation_results(results)
    ...
    for run = 1:3
        if run <= 2
            if ~copf
                ...
                for r = 1:numRelationships
                    ...
                    filenamePNG = strcat(saveLocation, filenamePre, "_vs_t_vs_macroItr_T_", num2str(T), "_Areas_", num2str(parentArea), ...
                        "_", num2str(childArea), "_",  suffixObj, "_", battstring, "_",  fileExtensionImage);
        ...
        elseif run == 3
            ...
            filenamePNG = strcat(saveLocation, filenamePre, "_vs_t_vs_macroItr_", num2str(T), "_", suffixObj, "_", battstring, fileExtensionImage);
            myexportgraphics(saveSimulationResultPlots, gcf, filenamePNG, 'Resolution', 300);
            filenameCSV = replace(filenamePNG, fileExtensionImage, fileExtensionData);
            writematrix(dependentVariable, filenameCSV)
