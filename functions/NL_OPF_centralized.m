function [V,S1, S_all, mic_iter, Dec_Var, time_dist] = NL_OPF_dist(Vs, Se,Area, end_area, loss_min, CVR)
...
tic
    ...
    [x,fval,exitflag,output] = fmincon(@objfun,x0,[],[],Aeq,beq,lb,ub, @eqcons , options);
