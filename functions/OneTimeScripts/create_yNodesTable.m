yNodes = struct();
yNodes.Names = ["P_ij", "Q_ij", "l_ij", "v_j", "qD_j", "B_j", "Pc_j", "Pd_j", "qB_j"].';
yNodes.VarNames = ["P_ij", "Q_ij", "l_ij", "v_j", "qD_j", "B_j", "Pc_j", "Pd_j", "qB_j"].';
yNodes.Units = ["kW", "kVAr", "pu", "pu", "kVAr", "kWh", "kW", "kW", "kVAr"].';
yNodes.FullNames = ["Branch Real Power Flow", "Branch Reactive Power Flow", ...
    "Branch Squared Current Flow", "Bus Squared Voltage", ...
